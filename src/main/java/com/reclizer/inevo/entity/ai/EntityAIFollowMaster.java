...
public class EntityAIFollowMaster extends EntityAIBase {
    private final EntityEnergyConstruct tameable;
    ...
    public EntityAIFollowMaster(EntityEnergyConstruct tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
    ...
    {
        EntityLivingBase entitylivingbase = this.tameable.getMaster();
