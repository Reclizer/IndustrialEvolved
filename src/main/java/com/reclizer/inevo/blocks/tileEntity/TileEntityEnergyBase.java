...
import com.reclizer.inevo.manager.GeneratorConfig;
import com.reclizer.inevo.tools.IRestorableTileEntity;
...
public class TileEntityEnergyBase extends TileEntity  implements ITickable, IRestorableTileEntity{
        ...
        public TileEntityEnergyBase() {
            asm = IndustrialEvolved.proxy.load(new ResourceLocation(IndustrialEvolved.MODID, "asms/block/generator.json"), ImmutableMap.of());
        }
