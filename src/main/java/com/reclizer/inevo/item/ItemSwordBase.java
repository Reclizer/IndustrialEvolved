...
public class ItemSwordBase extends ItemSword implements IHasModel {
    ...
    {
        return CommonFunctions.GetStringLocalTranslated(getUnlocalizedName() + IENBTDef.DESC_COMMON);
    }
    ...
    {
        return showFlavor ? (stack.getUnlocalizedName() + IENBTDef.FLAVOR_KEY)
                : (stack.getUnlocalizedName() + IENBTDef.DESC_COMMON);
    }
