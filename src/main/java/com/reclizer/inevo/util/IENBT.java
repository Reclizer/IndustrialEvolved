...
public class IENBT {
    ...
    public IENBT(NBTTagCompound srcNBT)
    {
    ...
    public void readFromBasic(NBTTagCompound tag)
    {
        if (tag != null)
        {
            pearlCount = tag.getInteger(IENBTDef.LEVEL_TAG);
            isEarth = tag.getBoolean(IENBTDef.IS_EARTH);
            isSky = tag.getBoolean(IENBTDef.IS_SKY);
        }
    }
    ...
    public void writeToBasic(NBTTagCompound tag)
    {
        ...
        tag.setInteger(IENBTDef.LEVEL_TAG, pearlCount);
        tag.setBoolean(IENBTDef.IS_EARTH, isEarth);
        tag.setBoolean(IENBTDef.IS_SKY, isSky);
    }
    ...
    public static NBTTagCompound getPlyrIdlTagSafe(EntityPlayer player) {
        ...
        NBTTagCompound idl_data = getTagSafe(data, IENBTDef.IDEALLAND);
    ...
    public static void setPlayerIdeallandTagSafe(EntityPlayer player, String key, int value) {
        ...
        data.setTag(IENBTDef.IDEALLAND, idl_data);
