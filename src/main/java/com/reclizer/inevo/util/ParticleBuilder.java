 ...
 * <p></p>
 * Singleton class that builds IndustrialEvolved particles. This is an alternative (and neater, I think) solution to vanilla's
 ...
 * in IndustrialEvolved's proxies.
 * <p></p>
 ...
 *
 * @author Electroblob
 * @since IndustrialEvolved
 */
// The number of different combinations of parameters now required for the various particle
// types in IndustrialEvolved made the method overloads in the proxies very cumbersome and inevitably resulted in redundant
...
public final class ParticleBuilder {
    ...
    /**
     * {@link ResourceLocation} constants representing the different types of particle added by IndustrialEvolved. These
     * effectively replace the enum {@code IndustrialEvolvedParticleType} from previous versions.
     * <p></p>
     * Individual constants have comments detailing their corresponding default parameters. A range of values indicates
     * randomness.
     * <p></p>
     * To register your own particle types, use {@link com.reclizer.inevo.client.particle.ParticleInevo#registerParticle(
     * ResourceLocation, com.reclizer.inevo.client.particle.ParticleInevo.IInevoParticleFactory)
     * ParticleIndustrialEvolved.registerParticle(ResourceLocation, IIndustrialEvolvedParticleFactory)}.
     */
    ...
    public static class Type {
        ...
        public static final ResourceLocation CLOUD = new ResourceLocation(IndustrialEvolved.MODID,"cloud");
        /** Spiral particle, like potions.<p></p><b>Defaults:</b><br>Lifetime: 8-40 ticks<br>Colour: white */
        public static final ResourceLocation DARK_MAGIC = new ResourceLocation(IndustrialEvolved.MODID,"dark_magic");
        /** Single pixel particle.<p></p><b>Defaults:</b><br>Lifetime: 16-80 ticks<br>Colour: white */
        public static final ResourceLocation DUST = new ResourceLocation(IndustrialEvolved.MODID,"dust");
        /** Rapid flash, like fireworks.<p></p><b>Defaults:</b><br>Lifetime: 6 ticks<br>Colour: white */
        public static final ResourceLocation FLASH = new ResourceLocation(IndustrialEvolved.MODID,"flash");
        /** Particle that looks like the guardian's beam attack.<p></p><b>Defaults:</b><br>Lifetime: 1 tick */
        public static final ResourceLocation GUARDIAN_BEAM = new ResourceLocation(IndustrialEvolved.MODID,"guardian_beam");
        /** Small shard of ice.<p></p><b>Defaults:</b><br>Lifetime: 8-40 ticks<br>Gravity: true */
        public static final ResourceLocation ICE = new ResourceLocation(IndustrialEvolved.MODID,"ice");
        /** Single leaf.<p></p><b>Defaults:</b><br>Lifetime: 10-15 ticks<br>Velocity: (0, -0.03, 0)
         * <br>Colour: green/brown */
        public static final ResourceLocation LEAF = new ResourceLocation(IndustrialEvolved.MODID,"leaf");
        /** 3D-rendered lightning particle.<p></p><b>Defaults:</b><br>Lifetime: 3 ticks<br> Colour: blue */
        public static final ResourceLocation LIGHTNING = new ResourceLocation(IndustrialEvolved.MODID,"lightning");
        /** 2D lightning effect, normally on the ground.<p></p><b>Defaults:</b><br>Lifetime: 7 ticks
         * <br>Facing: up */
        public static final ResourceLocation LIGHTNING_PULSE = new ResourceLocation(IndustrialEvolved.MODID,"lightning_pulse");
        /** Bubble that doesn't burst in air.<p></p><b>Defaults:</b><br>Lifetime: 8-40 ticks */
        public static final ResourceLocation MAGIC_BUBBLE = new ResourceLocation(IndustrialEvolved.MODID,"magic_bubble");
        /** Animated flame.<p></p><b>Defaults:</b><br>Lifetime: 12-16 ticks<br> */
        public static final ResourceLocation MAGIC_FIRE = new ResourceLocation(IndustrialEvolved.MODID,"magic_fire");
        /** Soft-edged round particle.<p></p><b>Defaults:</b><br>Lifetime: 8-40 ticks<br>Colour: white */
        public static final ResourceLocation PATH = new ResourceLocation(IndustrialEvolved.MODID,"path");
        /** Scorch mark.<p></p><b>Defaults:</b><br>Lifetime: 100-140 ticks<br>Colour: black<br>Fade: black */
        public static final ResourceLocation SCORCH = new ResourceLocation(IndustrialEvolved.MODID,"scorch");
        /** Snowflake particle.<p></p><b>Defaults:</b><br>Lifetime: 40-50 ticks<br>Velocity: (0, -0.02, 0) */
        public static final ResourceLocation SNOW = new ResourceLocation(IndustrialEvolved.MODID,"snow");
        /** Animated lightning particle.<p></p><b>Defaults:</b><br>Lifetime: 3 ticks */
        public static final ResourceLocation SPARK = new ResourceLocation(IndustrialEvolved.MODID,"spark");
        /** Animated sparkle particle.<p></p><b>Defaults:</b><<br>Lifetime: 48-60 ticks<br>Colour: white */
        public static final ResourceLocation SPARKLE = new ResourceLocation(IndustrialEvolved.MODID,"sparkle");
        /** 3D-rendered expanding sphere.<p></p><b>Defaults:</b><<br>Lifetime: 6 ticks<br>Colour: white */
        public static final ResourceLocation SPHERE = new ResourceLocation(IndustrialEvolved.MODID,"sphere");
        /** 3D-rendered vine particle.<p></p><b>Defaults:</b><br>Lifetime: 1 tick<br> Colour: green */
        public static final ResourceLocation VINE = new ResourceLocation(IndustrialEvolved.MODID,"vine");
    }
    ...
    public void spawn(World world){
        ...
        if(x == 0 && y == 0 && z == 0 && entity == null) IndustrialEvolved.logger.warn("Spawning particle at (0, 0, 0) - are you"
                + " sure the position/entity has been set correctly?");

        if(!world.isRemote){
            IndustrialEvolved.logger.warn("ParticleBuilder.spawn(...) called on the server side! ParticleBuilder has prevented a "
        ...
        com.reclizer.inevo.client.particle.ParticleInevo particle = IndustrialEvolved.proxy.createParticle(type, world, x, y, z);
