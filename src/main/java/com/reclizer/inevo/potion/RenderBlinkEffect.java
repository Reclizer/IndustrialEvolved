...
import com.reclizer.inevo.event.ClientEventHandler;
...
public class RenderBlinkEffect {
    ...
    private static final ResourceLocation SCREEN_OVERLAY_TEXTURE = new ResourceLocation(IndustrialEvolved.MODID, "textures/gui/blink_overlay.png");
