package com.reclizer.inevo.client.model.armor;// Made with Blockbench 4.5.1
...
public class ModelArmorAdapt extends ModelArmor {
...
//	private final ModelRenderer handR;
	...
	public ModelArmorAdapt(EntityEquipmentSlot slot) {
		super(slot);
//		textureWidth = 128;
//		textureHeight = 128;
		float s = 0.01F;
		...
		body.cubeList.add(new ModelBox(body, 0, 18, -4.5F, -0.5F, -2.5F, 9, 13, 5, 0.0F, false));

		leftArm = new ModelRenderer(this);
		leftArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
		leftArm.cubeList.add(new ModelBox(leftArm, 23, 35, -3.75F, -1.5F, -2.5F, 5, 12, 5, 0.0F, false));

		rightArm = new ModelRenderer(this);
		rightArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		rightArm.cubeList.add(new ModelBox(rightArm, 28, 18, -1.25F, -1.5F, -2.5F, 5, 12, 5, 0.0F, false));

		leftLeg = new ModelRenderer(this);
		leftLeg.setRotationPoint(-1.9F, 12.0F, 0.0F);
		leftLeg.cubeList.add(new ModelBox(leftLeg, 43, 40, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));

		rightLeg = new ModelRenderer(this);
		rightLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
		rightLeg.cubeList.add(new ModelBox(rightLeg, 0, 36, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));

		bootL = new ModelRenderer(this);
		bootL.setRotationPoint(-1.9F, 12.0F, 0.0F);
		bootL.cubeList.add(new ModelBox(bootL, 42, 29, -3.0F, 8.0F, -3.0F, 6, 5, 6, 0.0F, false));

		bootR = new ModelRenderer(this);
		bootR.setRotationPoint(1.9F, 12.0F, 0.0F);
		bootR.cubeList.add(new ModelBox(bootR, 36, 0, -3.0F, 8.0F, -3.0F, 6, 5, 6, 0.0F, false));
	}
